...
public class HoaDonXuat {
    ...
    public HoaDonXuat(int id,String nguoiBan, String maThuoc, String tenThuoc, String loaiThuoc, String tenKH, int donGia, String ngayXuat, int soLuong,int thanhTien) {
        this.id = id;
